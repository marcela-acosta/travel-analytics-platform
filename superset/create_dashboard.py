...
def main():
    ...
    chart_ids["pipeline_value"] = create_chart(
        s,
    ...
    chart_ids["win_agent"] = create_chart(
        s,
        "Win Rate by Agent",
        "echarts_bar",
        agt,
    ...
    chart_ids["win_product"] = create_chart(
        s,
        "Win Rate by Product",
        "echarts_bar",
        prd,
    ...
    chart_ids["region_opps"] = create_chart(
        s,
    ...
    # 6. Product Mix (pie)
    chart_ids["product_mix"] = create_chart(
        s,
        "Product Mix",
        "pie",
        opp,
    ...
    chart_ids["stale_by_stage"] = create_chart(
        s,
    ...
    chart_ids["stale_table"] = create_chart(
        s,
    ...
    s.put(
        ...
        json={"json_metadata": json.dumps({"chart_configuration": {}}), "owners": []},
    )
    ...
    print("     Login: admin / (see SUPERSET_ADMIN_PASSWORD in .env)")
